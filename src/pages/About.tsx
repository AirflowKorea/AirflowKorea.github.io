        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h2 className="text-3xl font-bold mb-6 text-airflow-navy">
                {t('mission.title')}
              </h2>
              ...
              <ul className="space-y-3 text-gray-600">
                {(t('mission.items', { returnObjects: true }) as string[]).map(
                  (item, index) => (
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3 text-gray-600">
                {(t('vision.items', { returnObjects: true }) as string[]).map(
                  (item, index) => (
                    <li key={index} className="flex items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                <h3 className="text-2xl font-bold mb-4 text-airflow-navy">
                  {t('activities.meetup.title')}
                </h3>
              ...
              <div className="md:w-1/2 bg-gray-100 p-8 rounded-xl">
                <div className="text-6xl text-center mb-4 flex justify-center text-blue-600">
                  <FaCalendar />
                </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8">
              ...
              <div className="md:w-1/2 bg-gray-100 p-8 rounded-xl">
                <div className="text-6xl text-center mb-4 flex justify-center text-green-600">
                  <FaUsers />
                </div>
                <div className="text-center text-gray-600">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="md:w-1/2 bg-gray-100 p-8 rounded-xl">
                <div className="text-6xl text-center mb-4 flex justify-center text-yellow-600">
                  <FaTrophy />
                </div>
                <div className="text-center text-gray-600">
                  {t('activities.opensource.stats', {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              ...
              <h3 className="text-lg font-bold mb-2">
                {t('values.cooperation.title')}
              </h3>
              <p className="text-gray-600 text-sm">
                {t('values.cooperation.description')}
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <div className="text-4xl mb-4 flex justify-center text-yellow-600">
                <FaStar />
              </div>
              <h3 className="text-lg font-bold mb-2">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <div className="text-4xl mb-4 flex justify-center text-purple-600">
                <FaGlobe />
              </div>
              <h3 className="text-lg font-bold mb-2">
